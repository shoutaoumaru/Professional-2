    ...
    <div class="superwrapper">
      <div class="svg-animation">
        <svg
          ...
          viewBox="0 0 380.06 99.83"
          width="380.05999755859375"
          height="99.83000183105469"
        >
          <path
            ...
            transform="translate(-115.52 -367.37)"
          ></path>
          <path
          ...
          <path
            ...
            d="M303.74,417l-16.38,25.56h-.24L276.38,417H283l5.58,15.72L297.5,417Z"
            transform="translate(-115.52 -367.37)"
          ></path>
          <path
      ...
      <div class="l-content" id="content">
        <div class="p-message">
          <div class="c-container appear up">
            <h3 class="c-txt-md clip-js left">Riv司法書士について</h3>
              ...
              <li>
                <a class="animsition-link" href=" <?php echo esc_url( home_url('/recruit')); ?>">
                  ...
                  <div class="p-index__desc appear up">
                    ...
                    <div class="p-index__text item">
                      <p class="c-txt-sm">
                        「人を育て、人を活かす。」そんな環境で私たちと一緒に歩んでみませんか。
        ...
        <div class="p-message">
          <div class="c-container appear up">
            <h3 class="c-txt-md clip-js left">
              Riv司法書士事務所だからできること
            </h3>
          </div>
        </div>
        <div class="p-feature">
          <div class="left">
            <div class="left-inner">
              ...
              <div>
                <p class="c-txt-sm">
                  Riv司法書士事務所では、20代からベテランまで幅広い年齢層が在籍しています。
                </p>
                <p class="c-txt-sm">
                  社内では活発にコミュニケーションをとっており、社内全体のレベルを高めながら
                  高い志をもって、お客さまの頼れる身近な法務相談役として問題を解決します。目指しています。
                </p>
              </div>
            </div>
          </div>
          <div class="right">
            <div class="right-inner">
              ...
              <span
                >お客さまの頼れる身近な法務相談役として問題を解決します。</span
              >
              <div>
                <p class="c-txt-sm">
                  開業20周年を迎えた今、当事務所は現状に甘んじることなく日々進化を追い求めております。
                </p>
                <p class="c-txt-sm">
                  登記業務を1本の柱として、常に社会のニーズに適合した柔軟且つ盤石な事務所を目指して今後50年、100年と続く事務所でありたいと思っております。
                </p>
              </div>
            </div>
          </div>
